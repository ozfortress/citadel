...
u = User.find_by(steam_id:)
puts 'Banning existing user' if u

u ||= User.create!(steam_id:, name: username)

# Ban from everything
u.ban(:use, :users, terminated_at:)
u.ban(:use, :teams, terminated_at:)
u.ban(:use, :leagues, terminated_at:)
u.ban(:use, :forums, terminated_at:)
