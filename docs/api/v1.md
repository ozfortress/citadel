...
### GET `/users/discord_id/:discord_id`

**If Discord integration is disabled, this endpoint will instead return 403: Forbidden**.

Options:
- `:discord_id`, the unique 64 bit Discord ID of the user
